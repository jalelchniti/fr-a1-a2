...
export const A1_NAVIGATION: SectionNavigation = {
    ...
    items: [
        ...
        { title: 'Langue', path: '/a1/language', icon: <PenTool size={ 16} /> },
    { title: 'Lecture', path: '/a1/reading', icon: <BookOpen size={ 16 } /> },
{
    title: 'Écoute', path: '/a1/listening', icon: <Headphones size={ 16 } /> },
  ],
};
    ...
    { title: 'Lecture', path: '/reading', icon: <BookOpen size={ 16 } /> },
{
    ...
    {
        title: 'Synthèse', path: '/language/summary', icon: <Layers size={ 16 } /> },
  ],
    };
