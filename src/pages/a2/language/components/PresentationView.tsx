...
import type { Presentation, VocabularyItem, GrammarRule } from '../languageA2Data';
    ...
    <div className={styles.presentationContainer}>
      ...
      <div className={styles.presentationSection}>
        ...
        <ul className={styles.objectivesList}>
          {selectedPresentation.objectives.map((obj: string, i: number) => (
      ...
      <div className={styles.presentationSection}>
        ...
        <div className={styles.vocabularyGrid}>
          {selectedPresentation.vocabulary.map((item: VocabularyItem, i: number) => (
      ...
      <div className={styles.presentationSection}>
        ...
        {selectedPresentation.grammar.map((rule: GrammarRule, i: number) => (
          <div key={i} className={styles.grammarCard}>
            <h3>{rule.title}</h3>
            <p>{rule.explanation}</p>
            <div className={styles.examplesGrid}>
              {rule.examples.map((ex: { french: string }, j: number) => (
      ...
      <div className={styles.presentationSection}>
        ...
        <div className={styles.tipsContainer}>
          {selectedPresentation.tips.map((tip: string, i: number) => (
