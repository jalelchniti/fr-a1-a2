...
import { levels, questionSets, type Level, type Question } from './languageData';
  ...
  if (showResults) {
    ...
    return (
      <div className="test-results">
        <div className="card-header"><Award size={24} className="text-accent" /><h2>Résultats du test ({levelTitle})</h2></div>
        <div className="results-summary">
          <p>Vous avez terminé le test de grammaire et vocabulaire.</p>
          ...
          {questions.map((q, index) => (
            <div key={q.id} className="result-item">
              <div className="result-question">
                ...
                <p>Question {index + 1}: {q.question.replace('______', `...`)}</p>
              </div>
...
export default function Language() {
  ...
  const handleTestComplete = (score: number, answers: (number|null)[]) => {
    ...
    localStorage.setItem(`language_test_results_${activeTest}`, JSON.stringify(answers));
          ...
          <div className="skill-layout">
            <div className="skill-main">
              <div className="content-card">
                  <div className="card-header"><BookA size={24} className="text-accent" /><h2>Choisissez un niveau de test</h2></div>
            ...
            <aside className="skill-sidebar">
              ...
              <div className="sidebar-card tip-card"><h4><Lightbulb size={18} /> Conseils</h4><ul className="tips-list"><li>Lisez attentivement chaque phrase</li><li>Faites attention aux accords</li><li>Vérifiez les temps des verbes</li></ul></div>
            </aside>
          </div>
        </div>
      </section>
