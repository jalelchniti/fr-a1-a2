...
export default function Language() {
  ...
  // Convert language questions to the format expected by EnhancedEvaluation
      ...
      <div className="skill-page">
        ...
        <section className="skill-content section">
          <div className="page-container" style={{maxWidth: '800px', margin: '0 auto'}}>
            <EnhancedEvaluation
              title={`Test de Grammaire & Vocabulaire - Niveau ${activeTest}`}
              subtitle="Répondez aux questions de grammaire et de vocabulaire"
              questions={questions}
